...
| CTL-007  | HZ-006               | TDU lock monitoring with automatic output inhibition on loss of timing synchronization         | Protective measure  | REQ-FUN-003, REQ-FUN-022              | VER-T-016                  | Prevents operation without valid timing reference |
...
| CTL-012  | HZ-010               | Independent power supplies for safety PLC and control electronics with UPS backup               | Reduction          | REQ-SAF-009                            | VER-T-019, VER-I-003      | Prevents common power failure from disabling both control and safety |
